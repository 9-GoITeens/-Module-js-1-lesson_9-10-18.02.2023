...
// ІІ варіант розвязку
// Спочатку ми скажемо якщо число непарне то пропусти цю ітерацію
// for (let i = min; i <= max; i += 1) {
//     if (i % 2 !== 0) {// !== логічне не
//         console.log('Непарні числа', i);
//         continue;//пропускаэ поточну ытерацыю
...
// ІІ варіант розвязку
// Також цю задачу можна розвязати за допомогою for of,
// оскільки нам не потрібно доступ до кожного елемента
...
//Також ми можемо цю задачку розвязати на for of
